...
const AREA_PASSWORD = "FACILIS2026"; // <-- CAMBIA QUI

function Protected({ children }: { children: React.ReactNode }) {
  const ok = sessionStorage.getItem("facilis_area_ok") === "1";
    ...
    <div className="page">
      <div className="card" style={{ position: "relative" }}>
          ...
          {pwOpen && (
            <div style={{ marginTop: 10, display: "flex", gap: 8, alignItems: "center" }}>
              ...
              <button
                ...
                onClick={() => {
                  if (pw === AREA_PASSWORD) {
                    sessionStorage.setItem("facilis_area_ok", "1");
                    navigate("/area-riservata");
                    setPwOpen(false);
                    setPwErr("");
                  } else {
                    setPwErr("Password errata");
                  }
                }}
              ...
              {pwErr && <div style={{ color: "red", marginLeft: 8 }}>{pwErr}</div>}
            </div>
          )}
        </div>

        <div className="under-construction">
          <img src={sitoInCostruzione} alt="Sito in costruzione" />
        </div>

        {/* 🔷 SOCIETÀ DI MANAGEMENT */}
        <div className="line">
          {" "}
          🏛️ <strong>FacilisManagER Srl</strong>
        </div>
        <div className="line">
          {" "}
          <strong>SOCIETÀ DI MANAGEMENT</strong>
        </div>

        <TextLine> </TextLine>
        <TextLine>
          {" "}
          <strong>Facilitazione</strong> tecnico-strategica a{" "}
          <strong>tutela</strong> dell’Assemblea Condominiale.{" "}
        </TextLine>
        <TextLine>
          {" "}
          La società opera esclusivamente{" "}
          <strong>nell’interesse</strong> della committenza{" "}
          <strong>condominiale</strong> e
        </TextLine>
        ...
        <TextLine>
          {" "}
          <strong>Facilitazione</strong> tecnico-strategica a{" "}
          <strong>tutela</strong> dell’Assemblea{" "}
          <strong>Condominiale</strong>
        </TextLine>
        <TextLine>
          {" "}
          (in coordinamento con Amministratore e Direzione Lavori).
        </TextLine>
        ...
        <Section title="⚙️ OFFERTA">
          ...
          <TextLine>
            Svolgo una funzione di <strong>facilitazione tecnico-strategica</strong> a
            tutela dell’assemblea condominiale, <strong>affiancando l’amministratore</strong> di
            condominio e la <strong>Direzione Lavori</strong> affinché le{" "}
            <strong>decisioni</strong> assembleari siano consapevoli, <strong>motivate</strong> e
            basate su elementi <strong>tecnici ed economici verificabili</strong>.
          </TextLine>
          <TextLine>
            Il mio <strong>ruolo</strong> nasce per garantire che l’assemblea:
          </TextLine>
          <Bullets
            items={[
              ...
              <>
                • <strong>decida</strong> con piena cognizione di causa,{" "}
                <strong>prima di impegnare risorse rilevanti</strong>.
              </>,
            ]}
          />
          <TextLine>
            <strong>Intervengo quando:</strong>
          </TextLine>
          <Bullets
            items={[
              <>
                • in assemblea emergono <strong>dubbi</strong> sulla{" "}
                <strong>congruità dei prezzi</strong> rispetto alla natura dell’opera,
              </>,
              <>
                • l’assemblea richiede una visione fattuale e concreta dell’intervento da
                realizzare,
              </>,
              <>
                • l’amministratore e la Direzione Lavori necessitano di un{" "}
                <strong>supporto indipendente</strong> per rappresentare in modo chiaro le{" "}
                <strong>scelte tecniche ed economiche</strong> all’assemblea.
              </>,
            ]}
          />
        </Section>
        ...
        <Section title="🤝 Come lavoro">
          <Bullets
            items={[
              <>
                • Opero <strong>nell’interesse primario dell’assemblea condominiale</strong>,
                lavorando in stretta <strong>collaborazione</strong> e coordinato con:
              </>,
              ...
              <>
                • <strong>evidenziare rischi e criticità</strong> potenziali prima che emergano
                in cantiere.
              </>,
            ]}
          />
        ...
        <Section title="📊 Attività principali">
          <Bullets
            items={[
              <>
                • Verifica della <strong>congruità tra prezzo preventivato</strong> e natura
                dell’opera, a <strong>tutela dell’assemblea.</strong>
              </>,
              ...
              <>
                <strong>Affiancamento</strong> ad amministratore e Direzione Lavori per{" "}
                <strong>conto dell’assemblea</strong> in caso di derive del cantiere, in termini:
              </>,
        ...
        <Section title="🛡️ Valore per l’Assemblea Condominiale">
          <Bullets
            items={[
              <>
                • <strong>Decisioni</strong> assembleari basate su <strong>fatti, dati</strong> e
                verifiche, non su percezioni.
              </>,
              <>
        ...
        <Section title=" ❌Cosa NON faccio">
          ...
          />
          <TextLine>
            👉 Rappresento esclusivamente <strong>l’interesse dell’assemblea condominiale</strong>{" "}
            nella qualità delle decisioni assunte.
          </TextLine>
          <TextLine> </TextLine>
          <TextLine>
            {" "}
            <strong>Perché questo posizionamento</strong> :
          </TextLine>
          <Bullets
            items={[
        ...
        <Section title="📎 Ruoli e responsabilità nel progetto">
          <Sep2 />
          <TextLine>
            <strong>🏢 ASSEMBLEA CONDOMINIALE </strong>
          </TextLine>
          <TextLine>
            {" "}
          ...
          />
          <TextLine>
            👉 Deve <strong>poter decidere</strong> in modo <strong>consapevole</strong> e informato.
          </TextLine>
          ...
          <div className="twoCols">
            <div className="colBox">
              <TextLine>
                <strong>🧾 AMMINISTRATORE DI CONDOMINIO</strong>
              </TextLine>
              <TextLine>
                {" "}
              ...
              />
              <TextLine>
                👉 <strong>Garantisce la corretta gestione</strong> amministrativa del processo.
              </TextLine>
            </div>
            ...
            <div className="colBox">
              <TextLine>
                {" "}
                <strong>🛠 DIREZIONE LAVORI</strong>
              </TextLine>
              <TextLine>
                {" "}
                <strong>Progetta e controlla l’esecuzione</strong>
              </TextLine>
              <Bullets
                items={[
                  <>
              ...
              />
              <TextLine>
                👉 È <strong>responsabile degli aspetti tecnici</strong> ed esecutivi.
              </TextLine>
            </div>
          </div>
          ...
          <TextLine>
            <strong>🧭 FACILITAZIONE TECNICO-STRATEGICA (FacilisManagER Srl)</strong>
          </TextLine>
          <TextLine>
            {" "}
            <strong>Tutela la qualità delle decisioni dell’Assemblea </strong>
          </TextLine>
          <Bullets
            items={[
              <>
          ...
          <TextLine>
            {" "}
            👉 Non decide, non esegue, <strong>non sostituisce nessuno</strong>:
          </TextLine>
          <TextLine>
            <strong>rende possibile</strong> una decisione consapevole.
          </TextLine>
        ...
        <Section title="📩 SEZIONE CONTATTO ">
          <TextLine>
            Compila i campi qui sotto: i dati ci arrivano via email e ti ricontattiamo telefonicamente.
          </TextLine>
          <TextLine>
            La richiesta è senza impegno e serve solo per inquadrare correttamente il progetto.
          </TextLine>
